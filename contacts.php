<!DOCTYPE html>
	<html>
		...
		<body>
			...
			<div id="language">
				<a href="contacts.php"><img src="icons/Ukraine.png" alt="logo" title="Українська" width="30" height="30"></a>
				<a href="ru/contacts.php"><img src="icons/Russia.png" alt="logo" title="Російська" width="30" height="30"></a>
			</div>
			<!--NAVIGATION-->
			...
			<main>
				<div class="contacts_text">
					...
					<div id="list"><p>
						<i>Губаренко Владислав Сергійович</i><br>
						(Голова правління)<br>
						Тел.(моб): +380667872611
						</p>
						<br>
						<p>
						<i>Меленчук Дмитро Русланович</i><br>
						(член правління)<br>
					...
					<a href="https://twitter.com/care_4_people" title="Група у Twitter" target="_blank">
						<img src="icons/social/bw/twitter.png" alt="twitter" title="Twitter" width="40" height="40">
					</a>
					<a href="https://www.instagram.com/z_turbotoiu_u_sertsi" title="Група у Instagram" target="_blank">
				...
				<div>
					<form class="contact_form" action="functions/contact-form-actions.php" method="post">
				        ...
				        <p>
	            			<label for="sub">Тема листа:</label>
	            			<input type="text"  name="sub" placeholder="Введіть тему листа" required />
	        			</p>
				        <p>
